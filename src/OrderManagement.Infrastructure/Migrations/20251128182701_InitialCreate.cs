        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingComplement = table.Column<string>(type: "text", nullable: true),
                    ShippingNeighborhood = table.Column<string>(type: "text", nullable: false),
                    ...
                    ShippingType = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    EstimatedDeliveryDays = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StockOffices", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StockOfficeId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItems_StockOffices_StockOfficeId",
                        column: x => x.StockOfficeId,
                        principalTable: "StockOffices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StockOfficeId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Stocks_StockOffices_StockOfficeId",
                        column: x => x.StockOfficeId,
                        principalTable: "StockOffices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_StockOfficeId",
                table: "OrderItems",
                column: "StockOfficeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProcessedMessages_MessageId_TenantId",
                table: "ProcessedMessages",
                columns: new[] { "MessageId", "TenantId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_Name_TenantId",
                table: "Products",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Skus_ProductId_ColorId_SizeId",
                table: "Skus",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Stocks_SkuId_StockOfficeId",
                table: "Stocks",
                columns: new[] { "SkuId", "StockOfficeId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Stocks_StockOfficeId",
                table: "Stocks",
                column: "StockOfficeId");
